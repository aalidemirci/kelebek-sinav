---
mevzuat-adi: "Millî Eğitim Bakanlığı Ortaöğretim Kurumları Yönetmeliği"
belge-turu: "yönetmelik"
resmi-gazete: "07.09.2013 / 28758"
kaynak: "mevzuat.gov.tr — MevzuatNo=18812, MevzuatTur=7, MevzuatTertip=5 (erişim 18.09.2026; son işlenen değişiklik RG-22/02/2025-32821)"
kapsam: "seçilmiş maddeler — programın evrak ve uyarılarında atıf yapılanlar (md. 36/7, 45, 48, 49, 86/4, 164)"
ilgili-moduller: [sinav, evrak]
etiketler: [yazili-sinav, mazeret, kopya, disiplin, sinav-sonucu, ozur-belgesi]
---

> **Bu dosya tam metin DEĞİLDİR.** Yalnız Kelebek Sınav'ın evrak şablonlarında,
> varsayılan takvim açıklamasında ve uyarı metinlerinde atıf yapılan maddeler
> resmî metinden **birebir** aktarılmıştır (kısaltma: **OKY**). Amaç: programdaki
> her madde atfının depoda doğrulanabilir olması (kılavuz kuralı: "madde numarası
> depodaki metinden gelir, uydurulmaz"). Yönetmelik sık değişir; sürüm
> güncellemelerinde atıflar bu dosyayla birlikte yeniden doğrulanmalıdır.
>
> **Atıf haritası (18.09.2026'da resmî metinle doğrulandı):**
>
> | Programdaki yer | Atıf | Hüküm |
> |---|---|---|
> | Salon Sınav Evrakı (R1) dayanağı | md. 45/1-a | Sınavlarla ilgili gerekli tedbirler okul müdürlüğünce alınır |
> | R1 dayanağı · takvim açıklaması md. 5 | md. 48/4 | Geçerli özrü olmadan katılmayan "G", kopya çeken "K" |
...
### Devam-devamsızlık (seçilmiş fıkra)
...
f) (Değişik:RG-8/9/2023-32303) Uygulamalı sınavların hangi derslerden yapılacağı, şekli, sayısı ve süresi eğitim kurumu sınıf/alan zümreleri tarafından belirlenir. Okul müdürünün onayına bağlı olarak uygulanır.
...
ğ) (Değişik ibare:RG-5/9/2019-30879) Kaynaştırma/Bütünleştirme yoluyla eğitimlerine devam eden öğrencilerin başarılarının değerlendirilmesinde Bireyselleştirilmiş Eğitim Programında (BEP) yer alan amaçlar esas alınır.

h) (Ek:RG-13/9/2014-29118) (Değişik:RG-8/9/2023-32303) Türk Dili ve Edebiyatı ile yabancı dil derslerinin her bir sınavı; dinleme, konuşma, okuma ve yazma becerilerini ölçecek şekilde yazılı ve uygulamalı olarak yapılır.

(2) (Değişik:RG-8/9/2023-32303) Sınavlar her alanın öğretim programlarında öngörülen ölçme ve değerlendirme ölçütlerine göre yapılır. Sınavlar, cevaplarını öğrencinin oluşturduğu ve farklı bilişsel düzeylerdeki kazanımları ölçen maddelerden oluşan yazılı yoklama şeklinde yapılır.

### Ölçme ve değerlendirmeye katılmayanlar

<a id="madde-48"></a>
MADDE 48- (1) (Değişik:RG-13/9/2014-29118) Sınavlara katılmayan, performans çalışmasını yerine getirmeyen veya projesini zamanında teslim etmeyen öğrencilerden, özrünü 36 ncı maddenin yedinci fıkrasına göre belgelendirenlerin mazeret sınavı ilgili zümrenin belirleyeceği bir zamanda önceden duyurularak bir defaya mahsus yapılır. Performans çalışması veya projesi kabul edilir. Ancak birinci dönemdeki özürler için belirlenen süre birinci dönemi, ikinci dönemdeki özürler için belirlenen süre ikinci dönemi aşamaz.
...
(2) (Değişik:RG-16/9/2017-30182) Yazılı sınav, uygulama, performans çalışması ve projelerin değerlendirme sonuçları, yazılı sınavın yapıldığı tarih veya performans çalışmasının, uygulamanın yahut projenin teslim tarihini takip eden 10 işgünü içinde öğrenciye duyurulur ve (Değişik ibare:RG-5/9/2019-30879) e-Okul/e-Mesem sistemine işlenir.
...
### Öğretmenler (seçilmiş fıkra ve bentler)
...
### Disiplin cezasını gerektiren davranış ve fiiller (seçilmiş fıkra ve bentler)

<a id="madde-164"></a>
MADDE 164- (1) (Değişik:RG-5/9/2019-30879) Kınama; öğrenciye, cezayı gerektiren davranışta bulunduğunun ve tekrarından kaçınmasının kesin bir dille ve yazılı olarak bildirilmesidir. Kınama cezasını gerektiren davranışlar ve fiiller şunlardır:
...
o) Eğitim ortamlarında; dersler arası ile öğle arası dinlenme sürelerinde okul yönetiminin izni dışında bilişim araçlarını yanında bulundurmak ve kullanmak.

(2) (Değişik:RG-5/9/2019-30879) Okuldan kısa süreli uzaklaştırma; öğrencinin ceza olarak verilen süre kadar ders ve ders dışı her türlü etkinlikten mahrum bırakılmasıdır. Okuldan 1-5 gün arasında kısa süreli uzaklaştırma cezasını gerektiren fiil ve davranışlar;
...
(3) (Ek cümle:RG-5/9/2019-30879) Okul değiştirme; öğrencinin yerleşim yeri öncelikli olmak üzere, aynı tür veya derecedeki başka bir okula naklinin yapılmasıdır. (Mülga ibare:RG-22/2/2025-32821) Okul değiştirme cezasını gerektiren fiil ve davranışlar;
