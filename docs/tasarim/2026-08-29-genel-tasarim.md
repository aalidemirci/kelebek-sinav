...
| **F3 Oturum akışı** | 5 adımlı sihirbaz; ExamSession+Course (tek-seviyeli); dağıtım+seed; durum makinesi; PlacementRule 4 tip; takas; yoklama; SNAPSHOT | Uçtan uca senaryo; onayda ihlal=0 şartı; arşivde mazeret güncellenebilir |
