# Anadolu Lisesi Haftalık Ders Çizelgesi (2025-2026 →)

- program_key: anadolu-lisesi-2025
- ad: Anadolu Lisesi Haftalık Ders Çizelgesi (TTK 09.05.2025/5)
- okul_turu: ANADOLU_LISESI, COK_PROGRAMLI_ANADOLU_LISESI
- hazirlik: hayır
- kaynak: TTK 09.05.2025 tarihli ve 5 sayılı karar, s. 2 — https://ttkb.meb.gov.tr/meb_iys_dosyalar/2025_05/20144001_202505.pdf
- yururluk: 2025-2026
- kademeli: hayır

Kaynak PDF `data/raw/` altında tutulur (git dışı); metin `pypdf` düzen kipiyle
çıkarılıp `scripts/cizelge_metninden_tablo.py` ile satırlara ayrıştırılmış,
evrakmotoru korpusundaki kanonik aktarımla (`mevzuat/ttkb-anadolu-lisesi-haftalik-
ders-cizelgesi-2025-05.md`) satır satır karşılaştırılmıştır (03.09.2026).

Kürasyon notları:

- Karar 2025-2026'dan itibaren TÜM sınıf seviyelerinde uygulanır (kademeli
  değil); 24.08.2023/37 çizelgesi aynı tarihte kaldırılmıştır.
- Hazırlık sınıfı bulunan okulların çizelgesi ayrı dosyadır
  (`anadolu-lisesi-hazirlik-2025.md`): 9-12 sütunları buradakiyle aynıdır,
  yalnız Hazırlık sütunu eklenir.
- Ders adı sonundaki çizelge dipnotları ("(2)", "*") ada dahil edilmemiştir.
- Sınav sütunu kürasyondur (tasarım §7.1): uygulama sınavıyla değerlendirilen
  dersler `UYGULAMA`; "Rehberlik ve Yönlendirme" ile "Hedef Temelli Destek
  Eğitimi" `YOK` — ikincisi için dayanak kararın AÇIKLAMALAR bölümü: "Ders
  notla değerlendirilmez. Sadece süreç değerlendirme yapılır."
- Ortak ders saati toplamları çizelgeyle çapraz kontrol edildi: 32/33/19/15.
...
| Görsel Sanatlar/Müzik | 9-11 | ORTAK | UYGULAMA |
| Beden Eğitimi ve Spor/Görsel Sanatlar/Müzik | 12 | ORTAK | UYGULAMA |
...
| Ders | Seviyeler | Tür | Sınav |
|---|---|---|---|
| Türk Kültür ve Medeniyet Tarihi | 9-12 | SECMELI | YAZILI |
